  ...
  return (
    <div className="fixed bottom-5 right-5 z-40 flex flex-col gap-3 sm:hidden">
      <a
        ...
        aria-label="Message White Wall on WhatsApp"
        className="grid h-14 w-14 place-items-center bg-[#25D366] text-white shadow-lg shadow-black/40 active:scale-95"
      >
      ...
      <a
        ...
        aria-label="Call White Wall"
        className="grid h-14 w-14 place-items-center bg-accent text-white shadow-lg shadow-black/40 active:scale-95"
      >
