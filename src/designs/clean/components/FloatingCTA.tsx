  ...
  return (
    <div className="fixed bottom-5 right-5 z-40 flex flex-col gap-3 sm:hidden">
      ...
      <a
        ...
        aria-label={`Call White Wall on ${business.phone}`}
        className="grid h-14 w-14 place-items-center rounded-full bg-brand-500 text-white shadow-lg shadow-black/20 active:scale-95"
      >
